package com.emssanar.microservicios.app.afiliados.controllers;
...
import com.emssanar.microservicios.app.afiliados.services.AfiliadoService;
...
public class AfiliadoController  extends CommonController<Afiliado, AfiliadoService>{
	
	@GetMapping("/uploads/img/{id}")
	public ResponseEntity<?> verFoto(@PathVariable Long id){
		Optional<Afiliado> o = service.findById(id);
